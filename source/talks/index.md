...
### 🧠 **Large Language Models, Architectures & Interpretability**

**Mixture-of-Recursions: Adaptive Token-Level Computation**  
📅 *February 2, 2026* · [Preview Slides (PDF)](https://pics.iamzhaokun.com/doc/talk/ATTPre_MoR.pdf)  
Presented the **Mixture-of-Recursions (MoR)** architecture in the seminar *Is Attention All You Need? The Search for a New Architecture*.  
Explained how MoR combines **recursive parameter sharing** with **token-level adaptive computation**, allowing different tokens to use different effective depths instead of passing through a fixed Transformer stack.  
Compared **expert-choice and token-choice routing**, discussed the challenges of **KV caching under dynamic depth**, and reviewed results showing up to **2.06× higher inference throughput** than a vanilla Transformer under the evaluated settings.
...
### 🩺 **Multimodal, Document & Clinical Language Understanding**

**DeepSeek-OCR: Contexts Optical Compression**  
📅 *January 16, 2026* · [Preview Slides (PDF)](https://pics.iamzhaokun.com/doc/talk/Document_AI_DeepSeek_OCR.pdf)  
Presented **DeepSeek-OCR** in the *Document AI* seminar, focusing on the idea of using the **visual modality as a compressed representation of textual context**.  
Explained the **DeepEncoder** architecture, which combines local visual processing, a **16× token compressor**, and global vision encoding before decoding with a Mixture-of-Experts language model.  
Discussed experiments on **vision-text compression, multilingual document parsing, and structured OCR**, highlighting how compact visual representations can reduce context length while retaining most of the information needed for document understanding.
...
📅 *February 3, 2025* · [Part I PDF](https://pics.iamzhaokun.com/doc/talk/Clinical%20Language%20Understanding%20Slides%20Part1.pdf) | [Part II PDF](https://pics.iamzhaokun.com/doc/talk/Clinical%20Language%20Understanding%20Slides%20Part2.pdf)  
